...
from apps.Cloned2.lib.PBS.Wrapper_Methods_F_Selection.Wrapper_Methods_Models.Regression_Models import \
    RFECV_RF_Regressor, RFECV_XGB_Regressor
...
class ALL_RGN_Modeling:
    ...
    def Building_Models_Reg(self):
        ...
        for model, grids in modelGeneratorFun():
            ...
            train_accuracy, test_accuracy, X_train, X_test, y_test, random_best, importances, grid, estimator, l, cm, target, model_file_name = model(X_train, y_train, X_test, y_test, grids, target)
