...
def User_XGBoost_Classifier_grids(xgb_objective, xgb_learning_rate, xgb_max_depth, xgb_min_child_weight,
                                  n_estimators_start, n_estimators_stop, XGBoost_Classifier_grids, default):
    if "default" == default:
...
def User_Multilayer_Perceptron_Classifier_grids(learning_rate_init, max_iter, hidden_layer_sizes, activation, alpha,
    ...
    if "default" == default:
        ...
        Multilayer_Perceptron_Classifier_grids = {
            'learning_rate_init': [ast.literal_eval(x) for x in learning_rate_init],
            # ast.literal_eval(learning_rate_init()[0]),
