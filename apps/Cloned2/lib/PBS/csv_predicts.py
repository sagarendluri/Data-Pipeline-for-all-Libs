    ...
    def csv_Predicts(self):
        # try:
            ...
            if "predict" == self.predict:
                ...
                model_instance = DataPrediction(data, i, pre_D,model_file,user_defined_terminology,sample_type ,description ,uom_type,cut_off,config_object_user ,aws_access_key_id,aws_secret_access_key,bucket_name ,analysis_id)
