...
def h2o_DB_upload(train_accuracy, test_accuracy, X_train, X_test, rmse, mse, rmsle, importances, grid, estimator, cm,
                  target, model_file_name, model, dname,
                  config_object_user, user_defined_terminology, sample_type, description, uom_type, analysis_id,
                  db_name, result, dataset_type, df ,mbe):
    #     try:
