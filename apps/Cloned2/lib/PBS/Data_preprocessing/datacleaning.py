...
#             print("Data analyzing")
            ...
            print("dtypes_handliing_exited with the error : ")#$%" % (Ex))
            print(Ex)
    ...
    def handiling_categorical(self):
        try:
            ...
            print("handiling_categorical_exited with the error : ")#$%" % (Ex))
            print(Ex)
    ...
    def handiling_int_col(self):
        try:
            ...
            print("Int_data_handling_exited with the error : ")#$%" % (Ex))
            print(Ex)
    ...
    def QC(self, cleaned_Data_frm, cleaned_Data_frm1, y):
        try:
            ...
            data_sorted =data_sorted.fillna(data_sorted.mean())
            return data_sorted
        except Exception as Ex:
            print("Int_data_handling_exited with the error : ")#$%" % (Ex))
            print(Ex)
    ...
    # data_sorted = self.data_sorted()
            self.data_sorted =self.data_sorted.fillna(self.data_sorted.mean())
