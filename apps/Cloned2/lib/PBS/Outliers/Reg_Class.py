...
# R =  Regression
# C =  Classification
class Outlier_R_and_C_Models:
    def __init__(self, path, i, ini, dname, config_object_user,
    ...
    def csv_Predicts(self):
        ...
        if y.dtypes == 'int64' or y.dtypes == 'int32':
            ...
            df = iqr(result)
            models = SK_models(df, y, i, label_types, dname, config_object_user, user_defined_terminology,
                               sample_type,
            ...
            df1 = iqr(df)
            models = ALL_RGN_Modeling(df1, y, i, label_types, dname, config_object_user, user_defined_terminology,
