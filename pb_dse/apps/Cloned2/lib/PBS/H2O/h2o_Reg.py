...
def h2o_RF(train, test, predictors, response, y_test):
...
def h2o_GB(train, test, predictors, response, y_test):
...
def h2o_XGB(train, test, predictors, response, y_test):
...
def h2o_Glm(train, test, predictors, response, y_test):
...
def h2o_DeepNN(train, test, predictors, response, y_test):
    ...
    grid = dl.get_params()
    print(grid)
    model_file_name = "H2ODeepNN_" + response + "_" + ".zip"
