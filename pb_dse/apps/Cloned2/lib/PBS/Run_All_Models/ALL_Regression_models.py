...
from apps.Cloned2.lib.PBS.SKlearn.All_Regression_objects import RandomForest_Regressor,XGBoost,K_Neighbors_Regressor,Multilayer_Perceptron_Regressor,Support_vector_regression
...
#                 try:
                    ...
                    model_ = "Sklearn_Reg"
                    Accuracy,random_best,importances,grid,estimator ,model_file_name,models= model(X_train , y_train,X_test, y_test,grids, target,model_)
                    user_defined_terminology = self.user_defined_terminology
