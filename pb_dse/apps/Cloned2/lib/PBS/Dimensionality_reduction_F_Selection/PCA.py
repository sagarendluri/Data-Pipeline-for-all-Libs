...
#                 try:
                    model_ = "PCA"
                    Accuracy,random_best,importances,grid,estimator ,model_file_name,models= model(pca_train , y_train,pca_test, y_test,grids, target,model_)
                    user_defined_terminology = self.user_defined_terminology
                    DB_upload(Accuracy,X_train_pca,X_test_pca,y_test,random_best,
